...
ab.Text="Remaing In Game(20Minuites un-till next Anti Kick)!"wait(2)ab.Text="Status: Active"end)se = Instance.new("TextButton"): Active"end)se = Instance.new("TextButton")